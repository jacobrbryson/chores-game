...
import { getPlayerCoins } from "@/lib/public-api/data";
...
export async function GET(
  ...
  return withPublicApi(request, ["read:coins"], async ({ requestId, rateLimit, token }) => {
    const result = await getPlayerCoins(token, playerId);
